...
public class S3GetMetadata extends S3Function {
	...
	public static Struct call(PageContext pc, String bucketName, String objectName, String accessKeyId, String secretAccessKey, String host, double timeout) throws PageException {
	...
	public Object invoke(PageContext pc, Object[] args) throws PageException {
		...
		if (args.length == 1) return call(pc, cast.toString(args[0]), cast.toString(args[1]), null, null, null, 0);

		throw engine.getExceptionUtil().createFunctionException(pc, "S3GetMetadata", 2, 7, args.length);
	}
}